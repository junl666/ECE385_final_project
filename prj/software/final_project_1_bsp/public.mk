...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../final_project_1.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../final_project_1_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is final_project_1_soc
SOPC_NAME := final_project_1_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x110b8
SOPC_SYSID_FLAG += --sidp=0x110b8
ELF_PATCH_FLAG  += --sidp 0x110b8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1716535020
SOPC_SYSID_FLAG += --timestamp=1716535020
ELF_PATCH_FLAG  += --timestamp 1716535020
