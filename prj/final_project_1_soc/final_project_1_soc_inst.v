	final_project_1_soc u0 (
		...
		.vga_port_color_index   (<connected-to-vga_port_color_index>),   //                .color_index
		.vga_port_game_status   (<connected-to-vga_port_game_status>)    //                .game_status
	);
